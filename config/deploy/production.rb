...
set :gateway, "ec2-184-73-210-198.compute-1.amazonaws.com"
...
set :email_to, [role_qa, role_pm, role_dev]

EC2_ADMIN_SERVER = "ec2-184-73-210-198.compute-1.amazonaws.com"
